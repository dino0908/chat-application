...
function Landing() {
  ...
  return (
    <Box sx={{ bgcolor: '#F5F5F7', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      {/* Navbar */}
      <AppBar 
        position="sticky" 
        elevation={0} 
      ...
      >
        <Toolbar sx={{ justifyContent: 'center' }}>
          <Typography variant="h6" sx={{ color: '#1d1d1f', fontWeight: 600, letterSpacing: -0.5 }}>
            ChatApp
          </Typography>
        </Toolbar>
      </AppBar>
        ...
        >
          ...
          <Tabs 
            ...
            sx={{ 
              ...
              '& .MuiTab-root': { color: '#86868b', textTransform: 'none', fontWeight: 500, fontSize: '1rem' },
